...
def generate_deterministic_click_task_data(batch_size, seq_len, n_neuron, n_cues=7):

    input_spikes = np.ones((batch_size, seq_len, n_neuron))
...
def get_data_dict(batch_size):
    ...
    spk_data, in_nums, target_data, _ = \
        generate_deterministic_click_task_data(batch_size=batch_size, seq_len=seq_len, n_neuron=n_in, n_cues=7)
